...
const t14 = (string) => {
  return string.trim() === "" ? false : string.trim();
};
...
document.querySelector(".b-16").addEventListener("click", function () {
  document.querySelector(".out-16").textContent = t16([4, 3, 6]);
});
...
document.querySelector(".b-19").addEventListener("click", function () {
  document.querySelector(".out-19").textContent = t19("111 test", true);
});
